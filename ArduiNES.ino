...
void setup() {
  ...
  for(unsigned int i = 0; i < MAX_POLY; i++){
    voices[i].env.setTimes(0,8000,64000,100);                         //sets ADSR levels for melodic voices
    voices[i].env.setADLevels(100,40);}                               //sets volume levels for melodic voices
  envNoise.setTimes(0,8000,64000,100);                                //sets ADSR levels for noise
  envNoise.setADLevels(100,40);                                       //sets volume levels for noise
